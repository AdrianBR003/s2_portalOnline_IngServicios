...
public class ProductService {
    ...
    public List<Product> inicializar(){
        ...
        if(productList.isEmpty()){
            ...
            productList.add(pr1);
            Product pr2 = new Product("Zapatillas 2","/images/zapatilla2.jpeg",50);
            productList.add(pr2);
            Product pr3 = new Product("Zapatillas 3","/images/zapatilla4.jpeg",40);
            productList.add(pr3);
            Product pr4 = new Product("Zapatillas 4","/images/zapatilla1.webp",30);
            productList.add(pr4);
            Product pr5 = new Product("Zapatillas 2","/images/zapatilla2.jpeg",60);
            productList.add(pr5);
            Product pr6 = new Product("Zapatillas 3","/images/zapatilla4.jpeg",90);
            productList.add(pr6);
